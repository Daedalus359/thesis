...
A second type of policy suitable for covering this environment is the low sweep policy (LSP). This policy moves back and forth across the environment using 
